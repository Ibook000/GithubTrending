...
每天更新的 GitHub Trending 中文技术榜单。用搜索、语言筛选、中文速览、跨榜标记和排名变化，帮你在十分钟内看懂开源世界正在发生什么。
...
每个仓库包含 `rank`、`previous_rank`、`movement`、`periods`、语言、Star、Fork、原始描述和中文摘要。首次记录或缺少可比较历史时明确标记为“新上榜”。
